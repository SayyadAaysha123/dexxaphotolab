...
import com.dexxaphotolab.app.Retrofit.Api;
import com.dexxaphotolab.app.payment.Config;
import com.dexxaphotolab.app.payment.Network.RetrofitClient;
import com.dexxaphotolab.app.payment.Utils.NetworkInst;
import com.dexxaphotolab.app.payment.Utils.RtlUtils;
import com.dexxaphotolab.app.Model.home_content.Video;
import com.dexxaphotolab.app.NewData.Adapter.CommonGridAdapter;
import com.dexxaphotolab.app.NewData.Util.SpacingItemDecoration;
import com.dexxaphotolab.app.NewData.Util.Tools;
import com.dexxaphotolab.app.NewData.model.CommonModels;
...
//        mAdapter = new CommonGridAdapter(this, list, "imovie", ItemPosterActivity.this);
    ...
    private void loadFragment(Fragment fragment) {
        ...
        ActivityHome.iv_home.setImageResource(R.drawable.nav_home);
        ActivityHome.iv_video.setImageResource(R.drawable.nav_video);
        ActivityHome.iv_image.setImageResource(R.drawable.nav_image);
        ActivityHome.iv_subscript.setImageResource(R.drawable.nav_crown1);
        ActivityHome.iv_createposter.setImageResource(R.drawable.nav_createpost);
        ActivityHome.iv_setting.setImageResource(R.drawable.nav_setting);
    }
