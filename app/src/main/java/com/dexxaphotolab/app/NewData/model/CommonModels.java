package com.dexxaphotolab.app.NewData.model;
...
public static Comparator<CommonModels> comparator = new Comparator<CommonModels>() {
    @Override
    public int compare(CommonModels commonModels, CommonModels t1) {
        return commonModels.getReleaseDate().compareTo(t1.getReleaseDate());
    }
};
