package com.dexxaphotolab.app.StickerClasses;
...
public class TextSticker extends Sticker {
  ...
  @NonNull public TextSticker setTextColor(@ColorInt int color) {
    ...
    @NonNull public TextSticker setTextShadow(@ColorInt int color) {
        textPaint.setShadowLayer(3,1,1,color);
  ...
  @Nullable public int getTextColor() {
    return textPaint.getColor();
  }
  @Nullable public int getShadowColor() {
    return shadowColor;
  }
