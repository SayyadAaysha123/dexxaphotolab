package com.dexxaphotolab.app.payment.activity;
...
import com.dexxaphotolab.app.payment.Network.apis.ProfileApi;
import com.dexxaphotolab.app.payment.Network.apis.SubscriptionApi;
import com.dexxaphotolab.app.payment.Network.apis.UserDataApi;
import com.dexxaphotolab.app.payment.Network.models.ActiveStatus;
...
import com.dexxaphotolab.app.payment.Utils.ApiResources;
import com.dexxaphotolab.app.payment.Utils.Constants;
import com.dexxaphotolab.app.payment.Utils.FileUtil;
import com.dexxaphotolab.app.payment.Utils.PreferenceUtils;
import com.dexxaphotolab.app.payment.Utils.RtlUtils;
import com.dexxaphotolab.app.payment.Utils.ToastMsg;
...
public class Business_DetailActivity extends AppCompatActivity {
    private static final String TAG = Business_DetailActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (substatus.equals("0")) {
            ...
            new Admanager(this).loadBanner(Business_DetailActivity.this, findViewById(R.id.banner_container));
        }
        ...
        id = PreferenceUtils.getUserId(Business_DetailActivity.this);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (etEmail.getText().toString().equals("")) {
                    Toast.makeText(Business_DetailActivity.this, "Please enter valid email.", Toast.LENGTH_LONG).show();
                    return;
                } else if (etName.getText().toString().equals("")) {
                    Toast.makeText(Business_DetailActivity.this, "Please enter name.", Toast.LENGTH_LONG).show();
                    return;
                } else if (etCompanyName.getText().toString().equals("")) {
                    new ToastMsg(Business_DetailActivity.this).toastIconError("Please enter company name.");
                    return;
                } else if (etCompanyAdd.getText().toString().equals("")) {
                    new ToastMsg(Business_DetailActivity.this).toastIconError("Please enter company address.");
                    return;
                }
        ...
        genderSpinner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(Business_DetailActivity.this);
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (response.code() == 200) {
                    if (response.body() != null) {
                        ...
                        Glide.with(Business_DetailActivity.this)
    ...
    private void updateProfile(String idString, String emailString, String phoneString, String nameString, String c_name, String c_address, String web, String pass) {
        ...
        try {
            if (imageUri != null) {
                file = FileUtil.from(Business_DetailActivity.this, imageUri);
            ...
            public void onResponse(Call<ResponseStatus> call, Response<ResponseStatus> response) {
                if (response.code() == 200) {
                    if (response.body().getStatus().equalsIgnoreCase("success")) {
                        new ToastMsg(Business_DetailActivity.this).toastIconSuccess(response.body().getData());

//                        saveUserInfo(user, user.getName(), etEmail.getText().toString(), user.getUserId());
                        Intent intent = new Intent(Business_DetailActivity.this, ActivityHome.class);
                        ...
                        new ToastMsg(Business_DetailActivity.this).toastIconError(response.body().getData());
                    }
                } else {
                    new ToastMsg(Business_DetailActivity.this).toastIconError(getString(R.string.something_went_wrong));
                }
                progressBar.setVisibility(View.GONE);
            }
    ...
    public void saveUserInfo(User user, String name, String email, String id) {
        ...
        DatabaseHelper db = new DatabaseHelper(Business_DetailActivity.this);
        db.deleteUserData();
    ...
    private void updateSubscriptionStatus(String userId) {
        ...
        call.enqueue(new Callback<ActiveStatus>() {
            ...
            public void onResponse(Call<ActiveStatus> call, Response<ActiveStatus> response) {
                if (response.code() == 200) {
                    if (response.body() != null) {
                        ...
                        Intent intent = new Intent(Business_DetailActivity.this, Business_DetailActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
            ...
            public void onFailure(Call<ActiveStatus> call, Throwable t) {
                t.printStackTrace();
                new ToastMsg(Business_DetailActivity.this).toastIconError(getResources().getString(R.string.something_went_wrong));
            }
        });
    }
