...
import com.dexxaphotolab.app.payment.Adapter.ActiveSubscriptionAdapter;
import com.dexxaphotolab.app.payment.Adapter.InactiveSubscriptionAdapter;
...
import com.dexxaphotolab.app.payment.Network.models.ActiveSubscription;
import com.dexxaphotolab.app.payment.Network.models.SubscriptionHistory;
...
public class SubscriptionActivity extends AppCompatActivity implements ActiveSubscriptionAdapter.OnItemClickLiestener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pactivity_subscription);
        ...
        if (substatus.equals("0")) {
            ...
            new Admanager(this).loadBanner(SubscriptionActivity.this, findViewById(R.id.banner_container));
        }
